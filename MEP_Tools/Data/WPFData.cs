...
namespace MEP_Tools
{
    ...
    { // Định nghĩa các biến thành viên  
        ...
        private Rebar.Main_Rebar inputWindow_rebar;
        public Rebar.Main_Rebar InputWindow_Rebar
        {
            get
            {
                if (inputWindow_rebar == null) inputWindow_rebar = new Rebar.Main_Rebar();
                return inputWindow_rebar;
            }
        }
