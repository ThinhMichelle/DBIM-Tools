...
namespace MEP_Tools
{
    class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication a)
        {
            ...
            const string Ribbon_panel10 = "STR Tools";
            ...
            #region "Images"
            //get image
            Image img_rebar = Properties.Resources.hanger_vertical;
            ImageSource imgSrc_rebar = Bmp_GetImage(img_hamger_v);
            #endregion
            #region "Create button"
            PushButtonData btn_Data_rebar = new PushButtonData("nRb_Rebar", "Create Rebar", Assembly.GetExecutingAssembly().Location, "MEP_Tools.Rebar.Create_Rebar")
            {
                ToolTip = TranslateText("Create rebar from link cad", lang_in, lang_out),
                LongDescription = TranslateText("You can create rebar from link cad in project", lang_in, lang_out),
                Image = imgSrc_hanger_v,
                LargeImage = imgSrc_hanger_v
            };
            ...
            #region "Add Butoon to the ribbon"
            //cls_Reg.B6 =
            PushButton btn_rebar = cls_Reg.panel_mep.AddItem(btn_Data_rebar) as PushButton;
            //cls_Reg.B6.Visible = false;
            #endregion
            #endregion
        ...
        public void GetDate()
        {
            try
            {
                ...
                string[] date = date_real[2].Split(new char[] { ' ' });
